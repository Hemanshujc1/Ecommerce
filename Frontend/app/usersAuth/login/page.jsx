        ...
        <div className="w-full md:w-1/2 p-10 flex flex-col justify-center">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-black text-white py-2 px-6 rounded-xl hover:bg-gray-800 hover:scale-95 transition uppercase text-sm disabled:opacity-60"
            >
